        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <AccentHeading
                as="h2"
                text="Brisbane's top choice for halal."
                accentIndex={4}
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                ...
                Our store doesn't stop at meats; we're stocked with diverse grocery
              ...
              <ul className="mt-8 space-y-3 text-sm">
                {[
                  "100% halal-certified beef, lamb, chicken, and goat",
                  "Fresh, ethically sourced meats cut to order",
                  "Diverse grocery essentials, exotic spices, and specialty foods",
                  "Exceptional customer service with expert butcher advice",
                ].map((t) => (
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                <a
                  href="https://www.facebook.com/pahalalbutcher/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="clay-btn-light clay-btn-light-hover inline-flex h-11 items-center gap-2 px-5 text-sm font-black text-ink"
                >
                ...
                <a
                  href="https://www.instagram.com/pahalalbutcher/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="clay-btn-light clay-btn-light-hover inline-flex h-11 items-center gap-2 px-5 text-sm font-black text-ink"
                >
